...
class OpenAIImageProvider(ImageProvider):
    """Not yet implemented: no OpenAI API key/testing available at design
    ...
    def generate(self, prompt: str, reference_images: list[bytes], **params: Any) -> ImageResult:
        raise NotImplementedError(
            "OpenAI image provider is not yet implemented. "
            "Implement ImageProvider.generate in providers/image/openai_image.py."
        )
